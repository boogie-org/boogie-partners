...
.. todo::
        Implement a function wrapping the frequently used
        ``datetime.now().strftime('%Y-%m-%d %H:%M:%S')`` so that the format is
        kept in a single place and is not repeated throughout the code.
